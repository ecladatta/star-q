    ...
    return (
      <div className="flex h-full min-h-0 items-center justify-center">
        <div className="text-center">
          ...
          <p className="mb-8 text-xl text-muted-foreground">Document not found</p>
          <Link
            href="/"
            className="inline-flex items-center rounded-md bg-accent px-4 py-2 text-accent-foreground transition-colors hover:bg-accent/90"
          >
            Go back home
          </Link>
        </div>
